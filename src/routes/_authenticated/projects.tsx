...
export const Route = createFileRoute("/_authenticated/projects")({
  head: () => ({
    meta: [
      { title: "Projects Kanban | Brandium Telesales CRM" },
      {
        name: "description",
        content:
          "Brandium CRM dynamic stage pipeline, creative workflows, and artist assignments generated from prospects.",
      },
      {
        property: "og:title",
        content: "Projects Kanban | Brandium Telesales CRM",
      },
      {
...
function ProjectsPage() {
  ...
  return (
    <div className="space-y-4">
      {/* Clean & Streamlined Filter Toolbar */}
      ...
      {/* Main Dynamic Kanban Content Area with Horizontal & Vertical ScrollArea */}
          ...
          {stages.map((stage) => {
            ...
            return (
              ...
              >
                ...
                {/* Column Body Cards (Drop Target with ScrollArea) */}
                      ...
                      stageProjects.map((project) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {/* Middle: Client Info / Contact Person & Phone */}
                            ...
                            {/* Bottom Row: Both Artist & Agent Avatars + Actions Menu */}
...
// --------------------------------------------------------------------------
// Sub-component: Project Form Modal (Edit)
// --------------------------------------------------------------------------
