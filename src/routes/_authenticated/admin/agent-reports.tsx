...
import { agentReportsQueryOptions, AgentReportPeriod, AgentMetrics } from "@/lib/agent-reports";
import { AdminAgentDetailModal } from "@/components/admin-agent-detail-modal";

export const Route = createFileRoute("/_authenticated/admin/agent-reports")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Agent Activity Reports | Brandium Telesales CRM" },
      {
  ...
  component: AdminAgentReportsPage,
});
...
function AdminAgentReportsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Period Selector Tabs — right side */}
      <Tabs
        value={period}
      ...
      >
        ...
        <TabsContent value={period} className="space-y-6">
          {/* Overall Financial Metrics (Won Value, Pipeline/Follow-up Value, Lost Value) */}
          ...
          {/* Tele-sales Agent Performance Matrix (Card Grid View) */}
            ...
            {isLoading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {filteredRankedAgents.map((ag, idx) => (
                  ...
                  >
                    <div>
                      {/* Modern Minimal Header with User Avatar */}
