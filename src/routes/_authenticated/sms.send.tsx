...
export const Route = createFileRoute("/_authenticated/sms/send")({
  head: () => ({
    meta: [
...
function SendSmsPage() {
  ...
  // Handle Prospect Select in Single SMS
  ...
  return (
    <div className="space-y-6">
        ...
        <TabsContent value="bulk" className="mt-4">
          <Card className="bg-white dark:bg-card border-slate-200/80 shadow-xs">
            ...
            <CardContent className="space-y-5">
              ...
              {/* Submit Trigger (Triggers Mandatory Confirmation Modal) */}
              <div className="flex justify-end">
                <Button
                  className="bg-[#67B239] hover:bg-[#5aa030] text-white gap-1.5 px-6"
      ...
      {/* Mandatory Bulk SMS Confirmation Modal */}
      <SmsBulkConfirmModal
