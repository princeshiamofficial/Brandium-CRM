...
import { reportsQueryOptions, ReportsFilters } from "@/lib/reports";
  ...
  head: () => ({
    meta: [
      { title: "Reports & Analytics | Brandium Telesales CRM" },
      {
        name: "description",
        content:
          "Filtered SQL aggregated reports, KPIs, stage distribution, and stage count analytics.",
      },
      { property: "og:title", content: "Reports & Analytics | Brandium Telesales CRM" },
      {
...
function ReportsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 2 Recharts Analytic Visualizations */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Chart 1: Prospect Stage Distribution (Donut / Pie Chart) */}
        ...
        {/* Chart 2: Stage Counts (Bar Chart) */}
        <Card className="bg-white dark:bg-card border-slate-200/80 shadow-xs">
          <CardHeader className="pb-2">
            <CardTitle className="text-base flex items-center gap-2">
