...
import {
  ...
  DeniedPayment,
  DeniedPaymentFilters,
} from "@/lib/denied-payments";
import { agentOptionsQueryOptions } from "@/lib/won-sales";

export const Route = createFileRoute("/_authenticated/denied-payments")({
  head: () => ({
    meta: [
      { title: "Denied Payments | Brandium Telesales CRM" },
      { name: "description", content: "Track clients who denied payment after sales completion." },
      { property: "og:title", content: "Denied Payments | Brandium Telesales CRM" },
      {
...
function DeniedPaymentsPage() {
  ...
  const totalDeniedAmount = deniedPayments.reduce((acc, curr) => acc + curr.amount, 0);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Relational Card Grid View of Denied Payments */}
      {isLoading ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {deniedPayments.map((item) => (
            ...
            >
              <div>
                {/* Top Section: Title, Amount, Red Warning Badge & Contact Details */}
                <div className="p-4 pb-3.5">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    {/* Top-right Solid Red Circle with Shield Warning */}
                ...
                {/* Middle Section: Soft Peach/Rose Container with Assigned, Denied by & Date */}
              ...
              {/* Modern Minimal Action Buttons Footer */}
      ...
      {/* Action Dialog 1: Follow Up Dialog */}
      <FollowUpDialog
        open={followUpOpen}
      ...
      {/* Action Dialog 2: Change Stage Modal (Creates Stage History) */}
      ...
      {/* Action Dialog 3: Stage History Modal */}
