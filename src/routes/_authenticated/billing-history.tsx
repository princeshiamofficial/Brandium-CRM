...
export const Route = createFileRoute("/_authenticated/billing-history")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Billing History | Brandium Telesales CRM" },
      {
...
function BillingHistoryPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Main Billing History Display (Desktop Table & Responsive Mobile Cards) */}
      <Card className="bg-white dark:bg-card border-slate-200/80 dark:border-slate-800 rounded-2xl shadow-xs overflow-hidden">
        ...
        {/* 1. Modern Desktop Table (10 Columns) */}
        ...
        {/* 2. Responsive Mobile Cards (Visible on mobile screens) */}
