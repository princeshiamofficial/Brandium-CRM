  ...
  head: () => ({
    meta: [
      { title: "Follow Ups | Brandium Telesales CRM" },
      {
        name: "description",
        content:
          "Track pending, completed, cancelled, and overdue follow-up calls across your telesales pipeline.",
      },
      { property: "og:title", content: "Follow Ups | Brandium Telesales CRM" },
      {
...
function FollowUpsPage() {
  ...
  const setStatus = (row: FollowUp, status: "completed" | "cancelled" | "pending") => {
    statusMutation.mutate(
      {
        id: row.id,
        status,
  ...
  return (
    <div className="space-y-6">
      {/* Top Page Header & Schedule Action */}
        ...
        {list.isLoading ? (
          ...
          <div className="space-y-4">
            {rows.map((row) => (
              ...
              >
                {/* 1. LEFT SECTION: Contact information (26% width) */}
                <div className="w-full xl:w-[26%] shrink-0 flex flex-col justify-between space-y-2.5 pr-1">
                  <div className="space-y-1.5">
                    ...
                    {/* Notes Box like Opportunities page */}
                ...
                {/* 2. MIDDLE SECTION: Follow-up timeline (55% width) */}
                ...
                {/* 3. RIGHT SECTION: Action buttons (19% width) */}
          ...
          <div className="flex items-center justify-between pt-3 border-t">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                onClick={() =>
                  void navigate({
                    search: (prev: FollowUpFilters) => ({ ...prev, page: page - 1 }),
                  })
                }
              >
