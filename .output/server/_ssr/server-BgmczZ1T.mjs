...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-tdwgLvCh.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DwPrv_1W.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cng_eGEH.mjs"),
		import("./start-C1ruQKDZ.mjs"),
