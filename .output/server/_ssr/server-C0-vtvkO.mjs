...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-A6lqC-Ad.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dpq_lcDS.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-tZSo5SEz.mjs"),
		import("./start-nvZSv-H3.mjs"),
