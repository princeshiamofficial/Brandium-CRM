...
import { o as fetchMySQLUsers, t as authenticateXamppUser } from "./auth.functions-CU_foW0i.mjs";
import { n as useAuth } from "./auth-DcRLmhBr.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { t as AccountSuspendedModal } from "./account-suspended-modal-CJQ9xUGd.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-CWtrDti0.js
...
function LoginPage() {
	...
	async function performLogin(targetEmail, targetPass) {
		...
		try {
			...
			if (res?.users) {
				const target = res.users.find((u) => String(u["email"] || "").toLowerCase() === targetEmail.trim().toLowerCase());
