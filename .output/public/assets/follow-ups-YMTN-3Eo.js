import{n as e,t}from"./client-Dk5KTcOZ.js";import{t as n}from"./mysql-api-C74RjZ50.js";import{i as r,t as i}from"./queryOptions-lNXbnasO.js";import{t as a}from"./useMutation-psWD_niU.js";import{t as o}from"./format-DSso9CUC.js";import{a as s,i as c,r as l}from"./types-DLFYuhRP.js";import{i as u}from"./admin-users-Dz7ih6iH.js";var d=c({page:l().catch(1),search:s().optional(),status:s().optional(),agent:s().optional(),from:s().optional(),to:s().optional()}),f=e=>e.status===`pending`&&new Date(e.due_at).getTime()<Date.now(),p=e=>f(e)?`overdue`:e.status,m=e=>{switch(e){case`completed`:return`default`;case`overdue`:return`destructive`;case`cancelled`:return`outline`;default:return`secondary`}},h=10,g=(e,t,r)=>i({queryKey:[`follow-ups`,e,t,r],queryFn:async()=>{try{let i=await n(`SELECT 
            f.*,
