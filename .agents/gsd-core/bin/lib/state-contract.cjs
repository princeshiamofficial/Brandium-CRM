 ...
 *     — the GEMINI.md-designated single OS-facing I/O seam. `platformWriteSync`
...
exports.PUBLISH_REASON =
  exports.PHASE_STATUS =
  exports.PHASE_KEY_ORDER =
  exports.CONTRACT_KEY_ORDER =
  exports.STATE_CONTRACT_FLAVOR =
  exports.STATE_CONTRACT_VERSION =
    void 0;
...
exports.CONTRACT_KEY_ORDER = Object.freeze([
  "contract",
  "flavor",
  "milestone",
  "phases",
...
function statusFromProgressCell(raw) {
  ...
  if (normalized === "complete") return exports.PHASE_STATUS.COMPLETE;
  if (normalized === "in progress") return exports.PHASE_STATUS.IN_PROGRESS;
...
function phasesFromChecklist(roadmapContent, cwd, statePath) {
  ...
  while ((match = pattern.exec(section.body)) !== null) {
    ...
    const status = checked
      ...
      : currentPhase !== null && number === currentPhase
        ? exports.PHASE_STATUS.IN_PROGRESS
        : exports.PHASE_STATUS.PENDING;
