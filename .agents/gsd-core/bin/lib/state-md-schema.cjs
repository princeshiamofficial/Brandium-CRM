...
exports.STATE_FIELD_SCHEMA = Object.freeze(
  Object.assign(Object.create(null), {
    ...
    milestone: {
      ...
      source: "external",
      preservation: "preserve-if-placeholder",
    ...
    current_phase: {
      ...
      bodySource: Object.freeze(["Current Phase"]),
      bodyLabel: "Current Phase",
      emitted: "when-present",
    },
    current_phase_name: {
      type: "string",
      ...
      source: "curated",
      preservation: "preserve-when-unchanged",
      bodySource: Object.freeze(["Current Phase Name"]),
    ...
    current_plan: {
      ...
      source: "body",
      preservation: "preserve-when-unchanged",
      bodySource: Object.freeze(["Current Plan"]),
      bodyLabel: "Current Plan",
    ...
    status: {
      type: "string",
      enum: exports.STATUS_LIFECYCLE_ENUM,
      cardinality: "one",
      source: "body",
      preservation: "preserve-when-unchanged",
      guard: "non-sentinel-unknown",
      bodySource: Object.freeze(["Status"]),
      bodyLabel: "Status",
      emitted: "always",
    },
    stopped_at: {
      ...
      source: "body",
      preservation: "preserve-when-unchanged",
      bodySource: Object.freeze(["Stopped At", "Stopped at"]),
      bodyLabel: "Stopped At",
      emitted: "when-present",
    },
    paused_at: {
      type: "string",
      ...
      source: "body",
      preservation: "preserve-when-unchanged",
      bodySource: Object.freeze(["Paused At"]),
      bodyLabel: "Paused At",
      emitted: "when-present",
    },
    // Activity log
    ...
    last_activity: {
      ...
      source: "body",
      preservation: "derive",
      bodySource: Object.freeze(["Last Activity", "Last activity"]),
      emitted: "when-present",
    ...
    last_activity_desc: {
      ...
      source: "body",
      preservation: "preserve-when-unchanged",
      bodySource: Object.freeze(["Last Activity Description"]),
      bodyLabel: "Last Activity Description",
      emitted: "when-present",
    },
    ...
    progress: {
      ...
      cardinality: "optional",
      source: "curated",
      preservation: "preserve-always",
      mergeStrategy: "progress-ratchet",
      emitted: "when-present",
    }, // #3242, #1446
