...
function normalizePhaseAlias(args, error) {
  ...
  if ((0, command_arg_projection_cjs_1.isFlagToken)(tok)) return { args, phase: undefined };
...
function routeInitCommand({ init, args, cwd, raw, error }) {
  routeCjsCommandFamily({
    ...
    unsupported: {},
    error,
    unknownMessage: (_subcommand, available) =>
      `Unknown init workflow: ${_subcommand}\nAvailable: ${available.join(", ")}`,
    handlers: {
      ...
      "execute-phase": () => {
        ...
        const namedArgs = (0, command_arg_projection_cjs_1.parseNamedArgsOrExit)(
          norm.args,
          { booleanFlags: ["validate", "tdd"], optionalValueFlags: ["wave"], positionals: 3 },
          error,
        );
      ...
      "new-project": () => {
        const namedArgs = (0, command_arg_projection_cjs_1.parseNamedArgsOrExit)(
          args,
          { booleanFlags: ["auto"], positionals: 2 },
          error,
        );
      ...
      "new-milestone": () => {
        const namedArgs = (0, command_arg_projection_cjs_1.parseNamedArgsOrExit)(
          args,
          { booleanFlags: ["reset-phase-numbers"], positionals: 2 },
          error,
        );
      ...
      onboard: () => {
        const namedArgs = (0, command_arg_projection_cjs_1.parseNamedArgsOrExit)(
          args,
          { booleanFlags: ["fast", "text"], positionals: 2 },
          error,
        );
      ...
      quick: () => {
        ...
        const namedArgs = (0, command_arg_projection_cjs_1.parseNamedArgsOrExit)(
          args,
          { booleanFlags: ["discuss", "research", "validate", "full"], positionals: "rest" },
          error,
        );
      ...
      "quick-batch": () => {
        const namedArgs = (0, command_arg_projection_cjs_1.parseNamedArgsOrExit)(
          args,
          { booleanFlags: ["research", "validate"], positionals: 2 },
          error,
        );
      ...
      "code-review": () => {
        ...
        const namedArgs = (0, command_arg_projection_cjs_1.parseNamedArgsOrExit)(
          norm.args,
          { booleanFlags: ["fix"], positionals: 3 },
          error,
        );
      ...
      "discuss-phase-assumptions": () => {
        ...
        const namedArgs = (0, command_arg_projection_cjs_1.parseNamedArgsOrExit)(
          norm.args,
          { booleanFlags: ["auto"], positionals: 3 },
          error,
        );
      ...
      progress: () => {
        const namedArgs = (0, command_arg_projection_cjs_1.parseNamedArgsOrExit)(
          args,
          { booleanFlags: ["forensic"], positionals: 2 },
          error,
        );
      ...
      autonomous: () => {
        const namedArgs = (0, command_arg_projection_cjs_1.parseNamedArgsOrExit)(
          args,
          { booleanFlags: ["converge", "cross-ai"], positionals: 2 },
          error,
        );
      ...
      update: () => {
        const namedArgs = (0, command_arg_projection_cjs_1.parseNamedArgsOrExit)(
          args,
          { booleanFlags: ["next", "rc"], positionals: 2 },
          error,
        );
      ...
      debug: () => {
        const namedArgs = (0, command_arg_projection_cjs_1.parseNamedArgsOrExit)(
          args,
          { booleanFlags: ["diagnose"], positionals: 2 },
          error,
        );
