...
exports.DEFAULT_CLINE_PROVIDER_ID =
  exports.clineGsdPlugin =
  exports.PLANNING_GUARD_REASON =
  exports.PLANNING_PATH_PATTERN =
  exports.WRITE_TOOL_PATTERN =
    void 0;
 ...
 */
exports.WRITE_TOOL_PATTERN =
  /write|edit|replace|create|delete|remove|append|apply|patch|insert|mkdir/i;
/**
 ...
 */
exports.PLANNING_GUARD_REASON = Object.freeze(
...
function inferProviderId(modelId) {
  if (typeof modelId !== "string" || modelId.length === 0) return exports.DEFAULT_CLINE_PROVIDER_ID;
