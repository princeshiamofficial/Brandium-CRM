...
exports.CLUSTERS = Object.freeze({
  ...
  milestone: Object.freeze(["new-milestone", "complete-milestone", "milestone-summary", "health"]),
  ...
  docs: Object.freeze(["docs-update", "ingest-docs"]),
  ui: Object.freeze(["ui-phase", "ui-review"]),
  ai_eval: Object.freeze(["ai-integration-phase", "eval-review"]),
