    ...
    return [
      {
        ...
        remedy: adviseRemedy(
          `Run the GSD installer: npx ${package_identity_cjs_1.PACKAGE_NAME}@latest`,
        ),
      },
    ];
  }
    ...
    return [
      {
        ...
        remedy: adviseRemedy(
          `Re-run the GSD installer to complete the install: npx ${package_identity_cjs_1.PACKAGE_NAME}@latest`,
        ),
      },
    ];
  }
