...
function cmdTemplateFill(cwd, templateType, options, raw) {
  ...
  switch (templateType) {
    ...
    case "plan": {
      ...
      const projectRef = toPosixPath(
        node_path_1.default.relative(cwd, node_path_1.default.join(planBase, "PROJECT.md")),
      );
      const roadmapRef = toPosixPath(
        node_path_1.default.relative(cwd, node_path_1.default.join(planBase, "ROADMAP.md")),
      );
      const stateRef = toPosixPath(
        node_path_1.default.relative(cwd, node_path_1.default.join(planBase, "STATE.md")),
      );
      body = [
    ...
    output(
      {
        ...
        path: toPosixPath(node_path_1.default.relative(cwd, outPath)),
      },
      raw,
      undefined,
    );
