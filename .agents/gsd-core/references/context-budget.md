...
Every plan carries an `estimate` block. It is the quantitative reason a phase must be sliced — tracer-first says _slice thin_, the estimate says _how thin, for this codebase_.
