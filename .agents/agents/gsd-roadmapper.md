...
`/gsd-new-milestone` run `.planning/ROADMAP.md` and `.planning/STATE.md` still hold the _outgoing_
...
`.planning/` artifacts. A hook inherits the _runtime's_ environment, so no per-step env var can reach
