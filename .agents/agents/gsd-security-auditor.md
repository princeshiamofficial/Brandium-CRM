...
**Verification depth scales with `asvs_level`** (see @.agents/gsd-core/references/security-asvs-levels.md for full definitions):
...
_Only blocking-open threats count toward `threats_open` in SECURITY.md frontmatter._
